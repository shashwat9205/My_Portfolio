...
const glowVariants = {
  ...
  hover:{
    scale:1.2 , y:-3, filter: "drop-shadow(0 0 8px rgba(13,88,204,0.9)) drop-shadow(0 0 18px rgba(16,185,129,0.8))",
...
React.useEffect(()=>{
  ...
  return(
    ...
    <span className="inline-block w-0.5 m-1 bg-white animate-pulse align-middle"
    style={{height:"1em"}}
    >
    ...
    className="px-6 py-3 rounded-full font-medium text-lg text-white
     bg-linear-to-r from-[#1cd8d2] via-[#00bf8f] to-[#302b63] shadow-lg 
