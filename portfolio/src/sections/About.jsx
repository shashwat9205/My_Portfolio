  ...
  return(
    ...
    <div className=" absolute inset-0 pointer-events-none"> 
        {glows.map((c,i)=> (
          ...
          <div 
          key={i} className={`absolute rounded-full bg-linear-to-r from-[#302b63] via-[#00bf8f] to-[#1cd8d2] animate-pulse ${c}`}
           />
        ))}
    ...
    <motion.div className="relative rounded-full w-40 h-40 md:w-50 md:h-50 overflow-hidden shadow-2xl bg-linear-to-br from-[#1cd8d2]/20 to-[#302b63]/20"
    ...
    >
      ...
      <p className='text-gray-300 leading-relaxed text-base sm:text-lg'> I’m a Software Developer, Content Creator, and Web Developer — passionate about building fast, resilient applications and sharing coding insights on Instagram and YouTube.</p>
